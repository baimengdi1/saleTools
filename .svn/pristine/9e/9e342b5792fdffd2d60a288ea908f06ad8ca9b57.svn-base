(function () {
  ...
  moTimeCJJ.prototype = {
    ...
    dataShow: function () {
      ...
      document.getElementById("time").appendChild(screenTimeBox);
    ...
    getTypeUl: function (_dom) {
      ...
      for (var i = 0; i < _this.typeList[_this.typeListIndex].length; i++) {
        ...
        str += "<div class='ulBox' style='height: " + _this.Liheight * 5 + "rem;width:" + 3.333 + "rem'><ul i='" + i + "'>" + liBox + "</ul><div class='dwwo'></div></div>";
      }
      ...
      for (var i = 0; i < dom2.getElementsByTagName("h6").length; i++) {
        dom2.getElementsByTagName("h6")[i].style.width = 3.333 + "rem";
      }
      _this.scrollLi();
